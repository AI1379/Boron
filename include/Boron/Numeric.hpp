...
template <UnsignedAndSigned T> inline bool mulOverflow(T v1, T v2, T *r) {
  return __builtin_mul_overflow(v1, v2, r);
    ...
    template <Unsigned T>
    inline bool addOverflow(T v1, T v2, T* r)
    {
    ...
    template <Unsigned T>
    inline bool subOverflow(T v1, T v2, T* r)
    {
    ...
    template <UnsignedAndSigned T>
    inline bool mulOverflow(T v1, T v2, T* r)
    {
...
template <> inline bool mulOverflow(int64_t v1, int64_t v2, int64_t *r) {
  return mulOverflow<int64_t>(v1, v2, reinterpret_cast<int64_t *>(r));
    ...
    template <>
    inline bool addOverflow(unsigned v1, unsigned v2, unsigned* r)
    {
    ...
    template <>
    inline bool addOverflow(uint64_t v1, uint64_t v2, uint64_t* r)
    {
